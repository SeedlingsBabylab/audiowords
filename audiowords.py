...
class MainWindow:
    ...
    def __init__(self, master):
        ...
        self.root.geometry("400x380")       # size of GUI window
        ...
        self.load_sound_button.grid(row=1, column=0)
        self.export_sound_button.grid(row=2, column=0)
        self.load_clan_button.grid(row=1, column=1)
        self.export_clan_button.grid(row=2, column=1)
        self.clear_clan_button.grid(row=3, column=1)

        # load minimum sound box to GUI
        self.minimum_sound_entry.grid(row=3, column=0)
        self.minimum_sound_label.grid(row=4, column=0, rowspan=2)
        ...
        self.silence_list_box.grid(row=0, column=0)
    ...
    def load_regions(self):
        ...
        if not self.minimum_sound_entry.get():
            ...
            self.minimum_sound_missing.grid(row=6, column=0)
    ...
    def export_regions(self):
        ...
        if self.silence_parser is None:
            self.minimum_sound_missing.grid_remove()
            self.sound_file_missing.grid(row=6, column=0)
    ...
    def load_clan(self):
        ...
        if self.clan_file != "":
            self.clan_loaded_label.grid(row=0, column=1)
    ...
    def export_clan(self):
        ...
        try:
            ...
            self.clan_formatting_error.grid(row=0, column=1)
            print e.args
